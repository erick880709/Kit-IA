...
PERMISOS_PANTALLA: dict[str, set[str]] = {
    ...
    "historial_paciente": {"Medico", "Enfermera", "Investigador", "Administrador"},
    "signos_vitales": {"Medico", "Enfermera", "Administrador"},
    "evaluacion_clinica": {"Medico", "Enfermera", "Administrador"},
    "clasificacion_ia": {"Medico", "Enfermera", "Administrador"},
    "explicacion_shap": {"Medico", "Enfermera", "Investigador", "Administrador"},
    "validacion_triaje": {"Medico", "Enfermera", "Administrador"},
    "cierre_evento": {"Medico", "Enfermera", "Administrador"},
